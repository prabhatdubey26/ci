      ...
      <section>
        <div class="container-fluid">
          <header>
            <div class="row">
                <div class="col-md-6">
                  <h1 class="h3 display">Add Blog</h1>
                </div>
                <div class="col-md-6 ">
                  <a href="<?=base_url('admin/blog')?>" class="btn btn-primary pull-right">LIST</a>
                </div>
            </div> 
          </header>
          <div class="row">
                  ...
                  <form role="form" method="post" id="add_contant_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Content</label>
                        <textarea class="form-control ckeditor" name="description" id="description"><?=isset($record['description'])?$record['description']:''?></textarea>
                    </div>
                    <div class="form-group">
                      <label>Image</label>
...
<script type="text/javascript">
    ...
    $('#add_contant_form').bind('submit', function () {
      ...
      if (id!='') {
          var url = '<?=base_url("admin/blog/edit/");?>'+id;
      }else{
